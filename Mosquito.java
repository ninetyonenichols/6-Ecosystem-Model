...
public class Mosquito extends Insect {
    ...
    public void breedWith(Animal other) {
        if (!species.equals(other.getSpecies()) || this.hasBred()
                || other.hasBred()) {
            return;
        }
        ...
        String[] infoArray = { "CREATE", coords, species, "female", "false",
                Boolean.toString(babyGene1CRISPR), Boolean.toString(babyGene2CRISPR) };
        ecosys.mkInhab(infoArray);

    }

    public boolean gene1CRISPR() {
        return gene1CRISPR;
    }

    public boolean gene2CRISPR() {
        return gene2CRISPR;
    }
}
